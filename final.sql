...
CREATE or replace VIEW bkk_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-100' ;
CREATE or replace VIEW bkk_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-100' ;
CREATE or replace VIEW bkk_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-100' ;
...
CREATE or replace VIEW pkt_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-101' ;
CREATE or replace VIEW pkt_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-101' ;
CREATE or replace VIEW pkt_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-101' ;
...
CREATE or replace VIEW cnx_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-102' ;
CREATE or replace VIEW cnx_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-102' ;
CREATE or replace VIEW cnx_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-102' ;
...
CREATE or replace VIEW kbi_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-103' ;
CREATE or replace VIEW kbi_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-103' ;
CREATE or replace VIEW kbi_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-103' ;
...
CREATE or replace VIEW ryg_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-104' ;
CREATE or replace VIEW ryg_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-104' ;
CREATE or replace VIEW ryg_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-104' ;
...
CREATE or replace VIEW ska_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-105' ;
CREATE or replace VIEW ska_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-105' ;
CREATE or replace VIEW ska_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-105' ;
...
CREATE or replace VIEW cri_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-106' ;
CREATE or replace VIEW cri_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-106' ;
CREATE or replace VIEW cri_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-106' ;
...
CREATE or replace VIEW plk_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-107' ;
CREATE or replace VIEW plk_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-107' ;
CREATE or replace VIEW plk_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-107' ;
...
CREATE or replace VIEW udn_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-108' ;
CREATE or replace VIEW udn_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-108' ;
CREATE or replace VIEW udn_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-108' ;
...
CREATE or replace VIEW kkn_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-109' ;
CREATE or replace VIEW kkn_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-109' ;
CREATE or replace VIEW kkn_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-109' ;
...
CREATE or replace VIEW npm_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-110' ;
CREATE or replace VIEW npm_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-110' ;
CREATE or replace VIEW npm_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-110' ;
...
CREATE or replace VIEW snk_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-111' ;
CREATE or replace VIEW snk_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-111' ;
CREATE or replace VIEW snk_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-111' ;
...
CREATE or replace VIEW ubn_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-112' ;
CREATE or replace VIEW ubn_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-112' ;
CREATE or replace VIEW ubn_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-112' ;
...
CREATE or replace VIEW sni_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-113' ;
CREATE or replace VIEW sni_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-113' ;
CREATE or replace VIEW sni_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-113' ;
...
CREATE or replace VIEW nst_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-114' ;
CREATE or replace VIEW nst_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-114' ;
CREATE or replace VIEW nst_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-114' ;
...
CREATE or replace VIEW trg_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-115' ;
CREATE or replace VIEW trg_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-115' ;
CREATE or replace VIEW trg_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-115' ;
...
CREATE or replace VIEW nwt_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-116' ;
CREATE or replace VIEW nwt_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-116' ;
CREATE or replace VIEW nwt_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-116' ;
...
CREATE or replace VIEW nan_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-117' ;
CREATE or replace VIEW nan_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-117' ;
CREATE or replace VIEW nan_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-117' ;
...
CREATE or replace VIEW ret_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-118' ;
CREATE or replace VIEW ret_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-118' ;
CREATE or replace VIEW ret_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-118' ;
...
CREATE or replace VIEW lei_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-119' ;
CREATE or replace VIEW lei_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-119' ;
CREATE or replace VIEW lei_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-119' ;
...
CREATE or replace VIEW brm_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-120' ;
CREATE or replace VIEW brm_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-120' ;
CREATE or replace VIEW brm_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-120' ;
...
CREATE or replace VIEW rng_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-121' ;
CREATE or replace VIEW rng_m   AS SELECT m.* FROM RSmaintanance m join RScar c on m.maintNo=c.maintNo WHERE c.branchNo='RSB-121' ;
CREATE or replace VIEW rng_cu   AS SELECT cu.* FROM RScustomer cu join RSrent r on cu.customerNo=cu.customerNo join RSbranch b on r.pickbranch=b.branchName WHERE b.branchNo='RSB-121' ;
...
CREATE or replace VIEW yla_r   AS SELECT r.* FROM RSrent r join RScar c on r.carno=c.carno WHERE c.branchNo='RSB-122' ;
...
create index RSCustomer_BT_IDX on rscustomer(CUSTOMERNO,FNAME,PHONE);
  ...
  -- CAR
  INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1005','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-100','RSM-002');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1071','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-101','RSM-014');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1075','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-102','RSM-016');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1110','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-103','RSM-017');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1107','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-104','RSM-029');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1143','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-105','RSM-033');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1211','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-106','RSM-038');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1179','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-107','RSM-045');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1001','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1002','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1003','NISSAN','M',2,1600,5,'Saloon','Benzine','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1004','TOYOTA','M',2,1600,5,'Saloon','Benzine','Auto','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1036','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-112',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1037','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-113',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1038','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-114',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1039','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-115',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1040','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-116',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1072','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-117',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1073','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-118',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1074','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-119',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1106','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-120',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1108','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-121',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1109','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-122',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1141','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1142','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-101',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1144','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-102',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1145','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-103',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1176','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-104',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1177','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-105',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1178','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-106',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1180','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1212','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1213','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1214','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1215','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1010','TOYOTA','M',2,1800,7,'SUV','Diesel','Auto','RSB-112','RSM-001');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1042','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-113','RSM-008');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1044','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-114','RSM-012');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1113','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-115','RSM-018');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1078','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-116','RSM-025');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1080','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-117','RSM-026');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1146','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-118','RSM-035');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1150','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-119','RSM-036');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1216','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-120','RSM-040');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1219','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-121','RSM-042');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1183','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-122','RSM-046');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1006','HONDA','M',2,1600,5,'SUV','Benzine','Auto','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1007','ISUZU','M',4,1800,2,'Pickup','Diesel','Manual','RSB-101',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1008','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-102',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1009','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-103',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1041','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-104',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1043','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-105',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1045','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-106',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1076','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1077','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1079','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1111','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1112','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1114','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-112',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1115','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-113',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1147','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-114',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1148','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-115',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1149','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-116',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1181','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-117',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1182','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-118',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1184','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-119',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1185','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-120',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1217','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-121',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1218','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-122',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1220','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1015','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-101','RSM-004');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1046','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-102','RSM-007');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1116','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-103','RSM-021');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1083','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-104','RSM-024');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1153','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-105','RSM-034');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1222','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-106','RSM-039');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1011','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1012','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1013','NISSAN','M',2,1600,5,'Saloon','Benzine','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1014','TOYOTA','M',2,1600,5,'Saloon','Benzine','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1047','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1048','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-112',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1049','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-113',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1050','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-114',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1081','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-115',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1082','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-116',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1084','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-117',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1085','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-118',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1117','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-119',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1118','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-120',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1119','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-121',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1120','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-122',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1151','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1152','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-101',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1154','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-102',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1155','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-103',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1186','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-104',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1187','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-105',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1188','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-106',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1189','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1190','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1221','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1223','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1224','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1225','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-112',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1020','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-113','RSM-003');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1017','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-114','RSM-009');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1054','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-115','RSM-013');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1121','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-116','RSM-020');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1088','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-117','RSM-027');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1160','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-118','RSM-037');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1227','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-119','RSM-041');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1192','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-120','RSM-047');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1229','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-121','RSM-048');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1016','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-122',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1018','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1019','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-101',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1051','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-102',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1052','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-103',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1053','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-104',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1055','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-105',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1086','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-106',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1087','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1089','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1090','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1122','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1123','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1124','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-112',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1125','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-113',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1156','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-114',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1157','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-115',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1158','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-116',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1159','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-117',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1191','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-118',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1193','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-119',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1194','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-120',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1195','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-121',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1226','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-122',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1228','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1230','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-101',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1024','TOYOTA','M',2,1600,5,'Saloon','Benzine','Auto','RSB-102','RSM-010');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1128','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-103','RSM-019');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1093','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-104','RSM-028');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1199','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-105','RSM-044');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1058','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-106','RSM-050');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1021','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1022','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1023','NISSAN','M',2,1600,5,'Saloon','Benzine','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1025','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1056','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1057','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-112',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1059','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-113',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1060','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-114',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1091','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-115',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1092','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-116',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1094','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-117',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1095','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-118',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1126','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-119',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1127','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-120',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1129','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-121',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1130','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-122',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1161','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1162','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-101',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1163','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-102',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1164','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-103',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1165','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-104',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1196','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-105',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1197','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-106',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1198','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1200','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1028','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-109','RSM-005');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1065','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-110','RSM-015');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1099','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-111','RSM-023');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1132','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-112','RSM-031');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1205','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-113','RSM-043');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1026','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-114',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1027','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-115',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1029','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-116',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1030','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-117',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1061','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-118',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1062','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-119',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1063','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-120',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1064','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-121',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1096','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-122',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1097','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1098','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-101',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1100','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-102',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1131','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-103',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1133','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-104',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1134','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-105',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1135','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-106',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1166','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1167','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1168','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1169','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1170','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1201','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-112',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1202','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-113',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1203','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-114',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1204','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-115',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1031','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-116','RSM-006');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1034','TOYOTA','M',2,1600,5,'Saloon','Benzine','Auto','RSB-117','RSM-011');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1105','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-118','RSM-022');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1137','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-119','RSM-030');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1140','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-120','RSM-032');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1171','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-121','RSM-049');
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1032','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-122',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1033','NISSAN','M',2,1600,5,'Saloon','Benzine','Auto','RSB-100',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1035','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-101',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1066','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-102',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1067','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-103',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1068','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-104',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1069','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-105',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1070','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-106',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1101','HONDA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-107',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1102','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-108',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1103','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-109',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1104','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-110',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1136','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-111',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1138','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-112',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1139','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-113',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1172','TOYOTA','S',1,1200,5,'Saloon','Benzine','Auto','RSB-114',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1173','NISSAN','M',2,1800,5,'Saloon','Benzine','Auto','RSB-115',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1174','TOYOTA','M',2,1800,5,'Saloon','Benzine','Auto','RSB-116',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1175','TOYOTA','L',3,2200,5,'Saloon','Benzine','Auto','RSB-117',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1206','HONDA','M',2,2000,5,'SUV','Benzine','Auto','RSB-118',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1207','ISUZU','M',4,1600,2,'Pickup','Diesel','Manual','RSB-119',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1208','TOYOTA','M',4,1800,5,'Pickup','Diesel','Auto','RSB-120',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1209','MITSUBITSHI','M',4,1800,5,'Pickup','Diesel','Auto','RSB-121',NULL);
INSERT INTO mytable(CarNo,Brand,CarSize,Luggage,Price,Seat,CarType,Engine,Transmission,branchNo,maintNo) VALUES ('RC-1210','TOYOTA','M',2,2000,7,'SUV','Diesel','Auto','RSB-122',NULL);
...
Select avg(salary)
from rsstaff
where branchno= 'RSB-100';


Select c.brand ,count(r.rentNo)
...
Select r.pickbranch,count(r.pickbranch)
From rsrent r join rscar c
On r.carno=c.carno
...
Select *
From cnx_r
where pickdate = '17-APR-16' and pickbranch = 'RSPT-CRI';

Select c.brand, count(c.brand)
From rscar c join rsrent r
On c.carno=r.carno
Where r.pickdate like '%04-JAN-16%'
Group by c.brand;
...
Insert into rsrent
VALUEs('RSR-0051','23-FEB-17','28-FEB-17','RSPT-BKK','RSPT-UDN','9000','RSC-1366','RC-1058','RS-206');

Insert into maintenance values
('RSM-051','28-AUG-17',	3200,	'Others',	'wash + coating');
select * from rsmaintenance;
